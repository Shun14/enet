...
TYPE_MAPPER = {"fp16": "float16", "fp32": "float32", "fp64": "float64", "float32": "float32", "float64":"float64"}

# 定义MaxUnpool2D
class MaxUnpool2D(nn.Layer):
    def __init__(self, kernel_size, stride=None, padding=0, align_corners=False):
    ...
    def __init__(self,
        ...
        self.ext_conv1 = nn.Sequential(
            nn.Conv2D(
                ...
                kernel_size=1,
                stride=1,
                bias_attr=bias), layers.SyncBatchNorm(internal_channels), activation())
        ...
        self.ext_conv3 = nn.Sequential(
            nn.Conv2D(
                ...
                kernel_size=1,
                stride=1,
                bias_attr=bias), layers.SyncBatchNorm(channels), activation())
    ...
    def __init__(self,
        ...
        self.ext_conv3 = nn.Sequential(
            nn.Conv2D(
                ...
                kernel_size=1,
                stride=1,
                bias_attr=bias), layers.SyncBatchNorm(out_channels), activation())
...
class enet_backbone(nn.Layer):
    ...
    def __init__(self, num_classes, encoder_relu=False, decoder_relu=True):
        super(enet_backbone, self).__init__()
